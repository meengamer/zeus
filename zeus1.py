...
👿 『Namelock On/off』
        ...
        ─┅═✥ᵀᴴᴬᴵᴸᴬᴺᴰ✥═┅─
      http://line.me/ti/p/~nowenowantsesses
      [By:ZEUS]
...
wait = {
    ...
    'message':"Thanks for add Me By:ZEUS",
    "lang":"JP",
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     cName = contact.displayName
                     balas = [""]
                     ret_ = "จิงๆสินะ " + random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
                     for mention in mentionees:
...
#----------------------------------------------------------------------------
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Add Line https://line.me/ti/p/~nowenowantsesses")
